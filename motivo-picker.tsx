    ...
    <div className="flex-1 flex flex-col items-center justify-center gap-4 p-6">
      <div className="text-center">
        <p className="text-g-4 text-xs uppercase tracking-widest mb-1">
          {selectedModulo}{moduleConfig.hasPerspective !== false ? ` · ${selectedPerspectiva === "propio" ? "Propio" : "Rival"}` : ""}
        </p>
      ...
      <button
        onClick={() => setStep(moduleConfig.hasPerspective !== false ? "perspectiva" : "modulo")}
